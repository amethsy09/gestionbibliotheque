    ...
    <div class="flex min-h-screen bg-gray-50 font-sans">
        ...
        <main class="flex-1 p-8">
            ...
            <div class="flex items-center mb-4 ">
                <h2 class="text-xl font-semibold">Liste des rayons</h2>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border rounded-lg overflow-hidden">
                    <thead class="bg-indigo-100 text-indigo-700">
                        <tr>
                            <th class="px-4 py-2">Nombres d'ouvrage</th>
                            <th class="px-4 py-2">nom</th>
                            <th class="px-4 py-2">capacite </th>
                    ...
                    <tbody class="bg-white">
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2">1e etage</td>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2">3e etage</td>
            ...
            <!-- Bouton flottant -->
            <a href="ajoutrayon.html#Modal" class="fixed bottom-6 right-6">
                <button
