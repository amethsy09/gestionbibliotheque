    ...
    <div class="flex min-h-screen bg-gray-50 font-sans">
        ...
        <main class="flex-1 p-8">
            ...
            <div class="flex items-center mb-4 ">
                <h2 class="text-xl font-semibold">Liste des Exemplaires</h2>
                            ...
                            <td class="px-4 py-2 relative">
                                ...
                                <div class="relative inline-block text-left">
                                    ...
                                    <div class="absolute right-0 mt-2 w-40 bg-white border rounded shadow-lg z-10">
                                        <a href="modifierexemplaire.html#Modal" class="block px-4 py-2 hover:bg-gray-100">Modifier</a>
            ...
            <!-- Bouton flottant -->
            <a href="ajoutexemplaire.html#Modal" class="fixed bottom-6 right-6">
                <button
