...
<head>
  ...
  <title>Ajouter un ouvrage - Modal</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center px-4">
  ...
  <button onclick="document.getElementById('modal').classList.remove('hidden')" 
          class="bg-blue-600 text-white px-6 py-3 rounded-xl shadow-lg hover:bg-blue-700 transition duration-300">
    <i class="ri-add-line mr-2"></i>Ajouter un ouvrage
  </button> -->
  ...
  <div id="modal" class="fixed inset-0 z-50 bg-black bg-opacity-50 hidden flex items-center justify-center">
    <div class="bg-white w-full max-w-4xl mx-4 md:mx-auto rounded-2xl shadow-xl p-8 md:p-10 relative overflow-y-auto max-h-[90vh]">
      ...
      <h2 class="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-2">
        <i class="ri-book-2-line text-blue-600 text-3xl"></i> Ajouter un ouvrage
      </h2>
      ...
      <form class="space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            <label class="block text-gray-700 font-medium mb-1">Rayon</label>
        ...
        <div>
          <h3 class="text-lg font-semibold text-gray-800 mb-3 flex items-center gap-2">
            <i class="ri-user-3-line text-blue-500"></i> Sélectionnez les auteurs
          </h3>
        ...
        <div>
          <h3 class="text-lg font-semibold text-gray-800 mb-3 flex items-center gap-2">
            <i class="ri-hashtag text-blue-500"></i> Mots-clés associés
          </h3>
          <div class="flex flex-wrap gap-4">
            <label class="flex items-center space-x-2">
              <input type="checkbox" class="text-blue-600" />
        ...
        <div>
          <h3 class="text-lg font-semibold text-gray-800 mb-3 flex items-center gap-2">
            <i class="ri-file-copy-line text-blue-500"></i> Exemplaires disponibles
          </h3>
          <div class="flex flex-wrap gap-4">
            <label class="flex items-center space-x-2">
              <input type="checkbox" class="text-blue-600" />
