    ...
    <div class="flex min-h-screen bg-gray-50 font-sans">
        ...
        <main class="flex-1 p-8">
            ...
            <div class="flex items-center mb-4 ">
                <h2 class="text-xl font-semibold">Liste des Auteurs</h2>
                ...
                <table class="w-full text-left border rounded-lg overflow-hidden">
                    ...
                    <tbody class="bg-white">
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2">mouhamed</td>
                            <td class="px-4 py-2">Ecrivain</td>
                            <td class="px-4 py-2 relative">
                                ...
                                <div class="relative inline-block text-left">
                                    ...
                                    <div class="absolute right-0 mt-2 w-40 bg-white border rounded shadow-lg z-10">
                                        <a href="modifierrayon.html#Modal" class="block px-4 py-2 hover:bg-gray-100">Modifier</a>
                                        <a href="#" class="block px-4 py-2 text-red-600 hover:bg-gray-100">Archiver</a>
                                        <a href="#" class="block px-4 py-2 hover:bg-gray-100">Ajout adherent</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr class="border-b">
                            <td class="px-4 py-2">Thiaw</td>
                            <td class="px-4 py-2">ahmad</td>
                            <td class="px-4 py-2">Historien</td>
                            <td class="px-4 py-2 relative">
                                <!-- Action dropdown -->
                                <!-- <div class="relative inline-block text-left">
                        <button class="px-2 py-1 bg-gray-100 rounded hover:bg-gray-200">⋮</button>
                        ...
                        <tr class="border-b">
                            <td class="px-4 py-2">thiam</td>
                            <td class="px-4 py-2">serigne</td>
                            <td class="px-4 py-2">chercheur</td>
                            <td class="px-4 py-2 relative">
                                <!-- Action dropdown
                      <div class="relative inline-block text-left">
                        <button class="px-2 py-1 bg-gray-100 rounded hover:bg-gray-200">⋮</button>
            ...
            <!-- Bouton flottant -->
            <a href="ajoutauteur.html#Modal" class="fixed bottom-6 right-6">
                <button
